...
let CommonServices = class CommonServices {
    ...
    renderToaster(validationMsgValue) {
        ...
        switch (validationMsgValue) {
            ...
            case ValidationMessages.ResetAll:
                this.toastr.info("", "All fields reset.", { positionClass: position, "closeButton": true, "progressBar": true });
                break;
            case ValidationMessages.NoPatientInThisName:
                this.toastr.info("No patient in this name.", "Not Found", { positionClass: position, "closeButton": true, "progressBar": true });
                break;
            ...
            case ValidationMessages.AlreadyBooking:
                this.toastr.warning("", "This Period already Booked!", { positionClass: position, "closeButton": true, "progressBar": true });
                break;
            // Error 
